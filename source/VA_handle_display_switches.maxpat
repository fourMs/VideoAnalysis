...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 759.5, 74.0, 133.0, 22.0 ],
					"text" : "VA_create_display_title"
				}

			}
, 			{
				"box" : 				{
					"comment" : "connect to Display",
					"id" : "obj-5",
					"index" : 3,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 759.5, 104.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 461.0, 74.0, 61.0, 22.0 ],
					"text" : "funnel 3 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 605.343231320381165, 108.0, 141.0, 22.0 ],
					"text" : "s VA_display_options_UI"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 461.0, 108.0, 134.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 287.0, 216.0, 110.0, 22.0 ],
					"text" : "t i i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 287.0, 329.0, 22.0, 22.0 ],
					"text" : "t 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 401.0, 365.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 401.0, 394.0, 72.0, 22.0 ],
					"text" : "syncinlet $1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 287.0, 283.0, 54.0, 22.0 ],
					"text" : "sel 1 2 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 416.0, 329.0, 29.5, 22.0 ],
					"text" : "i"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 15.0, 74.0, 430.5, 22.0 ],
					"text" : "t i i i i"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 332.5, 249.0, 104.0, 22.0 ],
					"text" : "s display-columns"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 378.0, 424.0, 70.0, 22.0 ],
					"text" : "columns $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 191.0, 256.0, 48.0, 22.0 ],
					"text" : "pak 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 191.0, 287.0, 49.0, 22.0 ],
					"text" : "2 $1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 77.5, 287.0, 49.0, 22.0 ],
					"text" : "1 $1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 287.0, 42.0, 22.0 ],
					"text" : "0 0 $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 289.333333333333314, 188.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 289.333333333333314, 159.0, 43.0, 22.0 ],
					"text" : "zl sum"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 289.333333333333314, 133.0, 58.0, 22.0 ],
					"text" : "pak 0 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 77.5, 183.0, 48.0, 22.0 ],
					"text" : "pak 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 77.5, 337.0, 50.0, 50.0 ],
					"rows" : 3
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 106.5, 14.0, 30.0, 30.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "toggle motion image",
					"id" : "obj-60",
					"index" : 3,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 220.0, 14.0, 30.0, 30.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "connect to router",
					"id" : "obj-61",
					"index" : 1,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 77.5, 459.0, 30.0, 30.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "connect to jit.glue",
					"id" : "obj-62",
					"index" : 2,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 378.0, 459.0, 30.0, 30.0 ]
				}
