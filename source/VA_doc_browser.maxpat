...
,
		"classnamespace" : "box",
		"rect" : [ 294.0, 81.0, 991.0, 754.0 ],
		"openrect" : [ 0.0, 0.0, 991.0, 637.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 235.0, 14.0, 164.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 235.0, 49.0, 45.0, 22.0 ],
					"text" : "wclose"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 592.0, 116.0, 34.0, 22.0 ],
					"text" : "exec"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 492.0, 35.0, 161.0, 22.0 ],
					"text" : "zoom, minimize, grow, menu"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 400.0, 14.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "path", "exec", "bang" ],
					"patching_rect" : [ 400.0, 43.0, 77.0, 22.0 ],
					"text" : "t path exec b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 458.0, 78.0, 214.0, 22.0 ],
					"text" : "nozoom, nominimize, nogrow, nomenu"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 458.0, 108.0, 81.0, 22.0 ],
					"text" : "prepend flags"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 458.0, 142.0, 96.0, 22.0 ],
					"text" : "prepend window"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 319.0, 169.0, 22.0, 22.0 ],
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 283.0, 301.0, 95.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 283.0, 270.0, 129.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 283.0, 234.0, 55.0, 22.0 ],
					"text" : "join"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 319.0, 202.0, 172.0, 22.0 ],
					"text" : "documentation/getStarted.html"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 283.0, 142.0, 55.0, 22.0 ],
					"text" : "zl ecils 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 283.0, 113.0, 143.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 235.0, 82.0, 67.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 145.0, 14.0, 49.0, 22.0 ],
					"text" : "forward"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 106.0, 14.0, 34.0, 22.0 ],
					"text" : "back"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 56.0, 14.0, 42.0, 22.0 ],
					"text" : "reload"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 14.0, 48.0, 22.0 ],
					"text" : "readfile"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2.5, 349.0, 532.0, 335.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, -1.0, 992.0, 639.0 ],
					"rendermode" : 1,
					"url" : "file:///C:/Users/User/Documents/GitHub/VideoAnalysis/documentation/getStarted.html"
				}
