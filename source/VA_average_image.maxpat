...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 49.0, 189.5, 43.5, 22.0 ],
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "reset" ],
					"patching_rect" : [ 240.0, 135.0, 42.0, 22.0 ],
					"text" : "t reset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 240.0, 101.0, 74.0, 22.0 ],
					"text" : "r reset_bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 86.0, 41.0, 109.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 338.0, 232.75, 134.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 461.0, 135.0, 273.0, 93.0 ],
					"text" : "for some weird reason (aka. bug) jit.normalize zeroes out the alpha plane with some videos so we have to manually fill it later. see this thread: https://cycling74.com/forums/problem-with-jit-normalize-and-exportimage"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 338.0, 204.5, 213.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 411.0, 65.0, 88.0, 20.0 ],
					"text" : "cropped image"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 99.0, 89.0, 95.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 99.0, 281.0, 185.0, 22.0 ],
									"text" : "join"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 99.0, 311.0, 122.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 265.0, 163.0, 137.0, 22.0 ],
									"text" : "v image-format"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 265.0, 194.0, 137.0, 22.0 ],
									"text" : "sel 0 1 2"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 99.0, 128.0, 185.0, 22.0 ],
									"text" : "t b b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 343.666666666666742, 236.0, 29.5, 22.0 ],
									"text" : "png"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 304.333333333333258, 236.0, 29.5, 22.0 ],
									"text" : "tiff"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 265.0, 236.0, 35.0, 22.0 ],
									"text" : "jpeg"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 99.0, 236.0, 60.0, 22.0 ],
									"text" : "tosymbol"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 99.0, 194.0, 85.0, 22.0 ],
									"text" : "sprintf %s-avg"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 99.0, 163.0, 88.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 73.5, 221.0, 72.0, 22.0 ],
					"text" : "print saving"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 49.0, 10.0, 141.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 338.0, 163.0, 75.0, 22.0 ],
					"text" : "jit.normalize"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 338.0, 135.0, 121.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 338.0, 280.0, 111.0, 22.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-77", 0 ],
					"midpoints" : [ 58.5, 267.0, 347.5, 267.0 ],
					"source" : [ "obj-7", 0 ]
				}
