...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 467.333333333333485, 53.0, 96.0, 22.0 ],
					"text" : "t l l l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 501.833333333333485, 171.0, 70.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 607.0, 198.0, 22.0, 22.0 ],
					"text" : "t 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 576.0, 198.0, 22.0, 22.0 ],
					"text" : "t 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 576.0, 171.0, 81.0, 22.0 ],
					"text" : "sel 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 576.0, 142.0, 91.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 576.0, 240.0, 63.0, 22.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 842.437499999999773, 151.0, 150.0, 75.0 ],
					"text" : "Stores movie-dim for correct batch-exporting. Only problem is that the user has to access every movie before exporting. "
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 736.75, 190.0, 92.0, 22.0 ],
					"text" : "0 0 $1 $2 $1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 667.5, 217.0, 88.25, 22.0 ],
					"text" : "join 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 667.249999999999886, 118.0, 88.25, 22.0 ],
					"text" : "t i b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 736.499999999999886, 151.0, 91.0, 22.0 ],
					"text" : "zl reg"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 807.999999999999886, 112.0, 91.0, 22.0 ],
					"text" : "route moviedim"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 807.999999999999886, 81.0, 76.0, 22.0 ],
					"text" : "r from-movie"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 526.812500000000227, 273.0, 161.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 370.333333333333485, 460.0, 38.0, 22.0 ],
					"text" : "zl reg"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 234.5, 84.0, 384.312500000000114, 22.0 ],
					"text" : "t b i i b i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 159.916666666666629, 474.0, 57.416666666666742, 22.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 198.333333333333371, 439.0, 54.916666666666629, 22.0 ],
					"text" : "zl reg"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 333.854166666666629, 323.0, 83.708333333333371, 22.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 444.833333333333485, 224.0, 91.0, 22.0 ],
					"text" : "r clear-crop-coll"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 28.916666666666629, 232.0, 136.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 563.5, 323.0, 192.0, 172.0 ],
					"text" : "Users can choose if they want the same cropping for each video, or to use different crop-settings. This also enables users to retract their most recent crop-setting, after using the \"same crop-setting\" for some time. \n\nIf theres a new video AND no crop-info, then trigger original movie dim. if new video + crop-info, then no movie-dim."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 28.916666666666629, 299.0, 42.0, 22.0 ],
					"text" : "t 0 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 87.416666666666629, 299.0, 52.0, 22.0 ],
					"text" : "t b 1 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "bang", "" ],
					"patching_rect" : [ 28.916666666666629, 267.0, 136.0, 22.0 ],
					"text" : "sel 1 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 110.250000000000114, 396.0, 144.333333333333371, 22.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 428.833333333333485, 193.0, 72.5, 22.0 ],
					"text" : "join 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 467.333333333333485, 129.0, 34.0, 21.0 ],
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 108.916666666666629, 512.0, 144.333333333333371, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 467.333333333333485, 21.0, 121.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 428.833333333333485, 161.0, 43.0, 21.0 ],
					"text" : "v item"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 307.5625, 273.0, 110.0, 21.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 234.5, 44.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 235.583333333333485, 365.0, 90.979166666666515, 22.0 ],
					"text" : "zl reg"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-32", 0 ],
					"midpoints" : [ 463.187500000000114, 142.0, 207.833333333333371, 142.0 ],
					"source" : [ "obj-14", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 553.833333333333485, 428.0, 243.75, 428.0 ],
					"source" : [ "obj-61", 2 ]
				}
