...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 5.700012000000072, 526.0, 82.0, 22.0 ],
					"text" : "mgt.luma2rgb"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 303.0, 128.0, 151.0, 34.0 ],
					"text" : "sends \"2\" when last frame is hit"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 303.0, 100.0, 136.0, 22.0 ],
					"text" : "r write_to_file_lastframe"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 303.0, 63.0, 151.0, 34.0 ],
					"text" : "sends \"1\" when first frame is hit"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 303.0, 39.0, 142.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 36.200012000000072, 582.0, 162.799987999999985, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 89.700012000000072, 287.0, 279.299987999999928, 22.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 89.700012000000072, 436.0, 279.299987999999928, 22.0 ],
					"text" : "join"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 350.0, 356.0, 39.0, 22.0 ],
					"text" : "round"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 225.533386000000007, 229.0, 32.0, 22.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 35.950012000000072, 129.0, 63.5, 22.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 225.533386000000007, 44.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 89.700012000000072, 526.0, 154.5, 22.0 ],
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 89.700012000000072, 474.0, 97.0, 22.0 ],
					"text" : "write $1 $2 h264"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 89.700012000000072, 321.0, 90.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 188.700012000000072, 321.0, 106.0, 22.0 ],
					"text" : "loadmess #1"
				}
...
, 			{
				"box" : 				{
					"fontsize" : 18.629492165496508,
					"id" : "obj-19",
					"maxclass" : "comment",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 36.200012000000072, 6.0, 267.0, 28.0 ],
					"text" : "#1 - suffix in exported file name"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 35.950012000000072, 189.0, 221.583373999999935, 22.0 ],
					"text" : "t 1 b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "bang", "" ],
					"patching_rect" : [ 35.950012000000072, 157.0, 185.09997599999997, 22.0 ],
					"text" : "sel 1 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "stop", "int" ],
					"patching_rect" : [ 119.000000000000057, 229.0, 51.0, 22.0 ],
					"text" : "t stop 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 36.200012000000072, 287.0, 38.333373999999935, 22.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 89.700012000000072, 387.0, 63.0, 22.0 ],
					"text" : "tosymbol"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 225.200012000000072, 561.0, 74.0, 22.0 ],
					"text" : "print saving"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 89.700012000000072, 356.0, 119.0, 22.0 ],
					"text" : "sprintf %s_%s.mp4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 55.533386000000007, 46.0, 25.0, 25.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 235.033386000000007, 103.0, 45.450012000000072, 103.0 ],
					"order" : 1,
					"source" : [ "obj-8", 0 ]
				}
